export const Footer = ({ showDriverPortal = false }: { showDriverPortal?: boolean }) => {
  const navigation = {
    ...
    social: [
        ...
        icon: (props: React.ComponentPropsWithoutRef<'svg'>) => (
          ...
          >
            <g id="g5" transform="scale(.58824)">
              ...
              ></path>
              <path id="polygon9" fill="#fff" d="M80.2 42.5L48.6 24.3v36.4z"></path>
            </g>
          </svg>
        ),
      },
      {
        name: 'GitHub',
        href: 'https://github.com/temporalio/samples-typescript/tree/main/food-delivery',
        icon: (props: React.ComponentPropsWithoutRef<'svg'>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
  ...
  return (
    <footer className="max-w-container mx-auto w-full bg-white pt-8">
      <div className="mx-auto max-w-7xl overflow-hidden border-t border-gray-200 px-6 py-12 lg:px-8 ">
